package com.lezhi.image.widget;

/**
 * Created by lezhi on 2017/8/6.
 */
...
public class VerticalTextView extends View {
    ...
    public VerticalTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.VerticalTextView_text) {
                text = a.getString(attr);

            } else if (attr == R.styleable.VerticalTextView_textColor) {
                textColor = a.getColor(attr, textColor);

            } else if (attr == R.styleable.VerticalTextView_textSize) {
                textSize = a.getDimensionPixelSize(attr, textSize);

            } else if (attr == R.styleable.VerticalTextView_columnSpacing) {
                columnSpacing = a.getDimensionPixelSize(attr, columnSpacing);

            } else if (attr == R.styleable.VerticalTextView_letterSpacing) {
                letterSpacing = a.getDimensionPixelSize(attr, letterSpacing);

            } else if (attr == R.styleable.VerticalTextView_regex) {
                regex = a.getString(attr);

            } else if (attr == R.styleable.VerticalTextView_textStyle) {
                textStyle = a.getInt(attr, textStyle);

            } else if (attr == R.styleable.VerticalTextView_leftLine) {
                leftLine = a.getBoolean(attr, false);

            } else if (attr == R.styleable.VerticalTextView_leftLinePadding) {
                leftLinePadding = a.getDimensionPixelSize(attr, leftLinePadding);

            } else if (attr == R.styleable.VerticalTextView_leftLineColor) {
